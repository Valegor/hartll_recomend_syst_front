  ...
  <div class="d-flex align-center flex-column">
    <v-row justify="center">
      <v-col cols="12" sm="12" md="12">
        <div class="text-subtitle-2 mt-2">ЛИНИИ ТКМ</div>
      </v-col>
    </v-row>
    ...
    <div v-for="item in items" :key="item">
      <v-card width="400" title="" :subtitle="item.LINE_NAME" text="подробнее" variant="outlined" class="mt-2" link
        @click="details(item.LINE_ID)"></v-card>
    </div>
  </div>
</template>
